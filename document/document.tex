...
\begin{figure}
    ...
    \scalebox{0.8}{
        \begin{tikzpicture}[main/.style={draw, circle, minimum size=30pt, line width=2pt}, info/.style={rectangle, rounded corners=5, draw}, n/.style={-latex, line width=0.75pt}, d/.style={-latex, line width=0.75pt, dashed}]
            % nodes
            \node[main] (X) at (0,0) {$X$};
            \node[main, ellipse] (*) at (0,2) {$*_{(ij,ij->ij)}$};
            % edges
...
\begin{figure}
    ...
    \scalebox{0.8}{
        \begin{tikzpicture}[main/.style={draw, circle, minimum size=30pt, line width=2pt}, info/.style={rectangle, rounded corners=5, draw}, n/.style={-latex, line width=0.75pt}, d/.style={-latex, line width=0.75pt, dashed}]
            ...
            \node[main, ellipse] (1*1) at (5,2) {$*_{(abij,ij->abij)}$};
            ...
            \node[main, ellipse] (3*1) at (11,2) {$*_{(abij,ij->abij)}$};
            \node[main] (3delta2) at (14,0) {$\delta_2$};
            \node[main] (3x2) at (16,0) {$X$};
            \node[main, ellipse] (3*2) at (15,2) {$*_{(abij,ij->abij)}$};
            \node[main] (3+) at (13,4) {$+$};
            % edges
            \draw [->, n] (1delta1) -- (1*1);
            \draw [->, n] (1x1) -- (1*1);
...
\begin{figure}
    ...
    \scalebox{0.8}{
        \begin{tikzpicture}[main/.style={draw, circle, minimum size=30pt, line width=2pt}, info/.style={rectangle, rounded corners=5, draw}, n/.style={-latex, line width=0.75pt}, d/.style={-latex, line width=0.75pt, dashed}]
            ...
            \node[main, ellipse] (1*1) at (1,2) {$*_{(abij,ij->abij)}$};
            \node[main] (+) at (1,4) {+};
            % edges
            \draw [->, n] (1delta1) -- (1*1);
            \draw [->, n] (1x1) -- (1*1);
