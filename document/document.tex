...
Then, the parsing and representation of tensor expressions are discussed.
...
...
$B$ is either empty or contains two child nodes, $\text{left}(B)$ and $\text{right}(B)$, which are also binary trees and have $B$ as their only parent.
