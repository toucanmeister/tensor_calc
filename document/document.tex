...
Following that, we elaborate on the details of our implementation of the procedure and the rules.
...
However, as can be seen in the corresponding Lemma 1 on the previous page of the paper, %Todo: Explain why the problem occurs.
