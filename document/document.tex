...
To unify the formal definition with our intuitive characterization, refer to empty nodes as nonexistant and omit them from graphical representations.
...
Because we may need the tensor order of all nodes in the orignal DAG, we determine them by propagating tensor orders from the bottom of the DAG toward the root.
...
$$\bar{g'} = \frac{g(x_1,... x_k-h,... x_n) - g(x_1,... x_k+h,... x_n)}{2h}$$ 
